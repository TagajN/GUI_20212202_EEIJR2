...
namespace Game.Model.Characters
{
    public class WarlockModel : ObservableObject, ICharacter
    {
        ...
        public WarlockModel(int hp, int chlevel, int experience, int damage, string name, int xCordinate, int yCordinate, int characterWidth, int characterHeight, int horizDegree)
        {
            this.hp = hp;
