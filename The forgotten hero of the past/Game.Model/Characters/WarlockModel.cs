...
{
    public class WarlockModel : ObservableObject, ICharacter
    {
        private int hp;
        private int chlevel;
        ...
        public WarlockModel(int hp, int chlevel, int experience, int damage, string name, double xCordinate, double yCordinate, int characterWidth, int characterHeight, double horizDegree)
        {
            this.hp = hp;
