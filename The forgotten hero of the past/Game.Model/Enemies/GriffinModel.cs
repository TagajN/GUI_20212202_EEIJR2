...
{
    public class GriffinModel : ObservableObject, IEnemy
    {
        private int hp;
        private int damage;
        ...
        public GriffinModel(int hp, int damage, double xCordinate, double yCordinate, int characterWidth, int characterHeight, double horizDegree)
        {
            this.hp = hp;
            this.damage = damage;
