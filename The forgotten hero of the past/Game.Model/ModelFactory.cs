...
namespace Game.Model
{
    public class ModelFactory
    {
        ...
        public static KnightModel CreateKnight(int xCordinate, int yCordinate, int characterWidth, int characterHeight, int hp = 200, int chlevel = 0, int experience = 0, int damage = 35, string name = "Knight")
        {
            return new KnightModel(hp, chlevel, experience, damage, name, xCordinate, yCordinate, characterWidth, characterHeight);
        }
        public static StormMageModel CreateStormMage(int xCordinate, int yCordinate, int characterWidth, int characterHeight, int horizDegree, int hp = 150, int chlevel = 0, int experience = 0, int damage = 50, string name = "StormMage")
        {
        ...
        public static WarlockModel CreateWarlock(int xCordinate, int yCordinate, int characterWidth, int characterHeight, int horizDegree, int hp = 130, int chlevel = 0, int experience = 0, int damage = 65, string name = "Warlock")
        {
